...
| Maddeninator Findings — Real-Side Anchors | `docs/design-docs/MADDENINATOR_FINDINGS.md` | Opus 2026-07-14. The decision-grade consolidation of the Madden real-side anchors (M2 read) — the input for the W-L/talent-spread campaign re-plan. Team-OVR↔wins 0.365 vs sim 0.435 (deficit is LUCK not spread) · QB partial-corr 0.284 dominant, EDGE weak (0.074), non-QB flat ~0.10 · offense drives wins 2.2× defense. Re-plan seed: quality-orthogonal variance + concentrate win-drive on QB/offense. Drive `1IANOqTpSyYU9bT6aA_uA8GXB0oQi5yTw`. |
