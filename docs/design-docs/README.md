...
| Talent Spread — Expression-Scale Recalibration | `docs/design-docs/TALENT_SPREAD.md` | Authored 2026-07-13 (Fable; W-L pass-delta endgame). Diagnosis (talent spread ½ real, luck at floor, shuffle-null 1.02, persistence 0.71 vs 0.57) STANDS. **⛔ MECHANISM FALSIFIED at implementation (Opus 2026-07-14):** widening the drive-sim efficiency channels raises wins-sd but moves the pass delta the WRONG way (22.9→25.8) — winning & out-gaining are coupled. Reverted, no code shipped. §0 records the re-plan direction (turnover / non-yardage win channel). Drive backup `1uAZZR7GGOEJoxoa2UFsNDyW7Mv_LcUZm` (supersedes `1Gwjlro6…`, `12e84IL4…` — trash both). Back to Fable to re-plan. |
